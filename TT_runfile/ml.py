...
for val in values:
    ...
    df = pd.read_csv(f'/home/jhy/code/TradeTrend/data/{val[0]}_temp.csv')
    ...
    # for j,k in enumerate(tmp_count_list):
        ...
        df_acc_7.to_csv(f'/home/jhy/code/TradeTrend/data/{val[0]}_Accuracy_7.csv',index=False)
        ...
        df_acc_30.to_csv(f'/home/jhy/code/TradeTrend/data/{val[0]}_Accuracy_30.csv',index=False)

    pd.DataFrame(result_list,index=model_names,columns=target).to_csv(f'/home/jhy/code/TradeTrend/data/{val[0]}_result.csv')
